...
- [x] 3. ユースケースとポートインターフェースを定義する
- [x] 3.1 (P) リポジトリポートインターフェースを定義する
...
- [x] 3.3 Memberプロフィール取得ユースケースを実装する
...
- [x] 4. リポジトリ実装とデータマッパーを構築する
- [x] 4.1 Supabaseクライアント設定を整備する
...
- [x] 4.2 SupabaseMemberRepositoryを実装する
...
- [x] 4.3 SupabaseEventRepositoryを実装する
...
- [x] 4.4 PostgreSQL関数によるトランザクション処理を実装する
...
- [x] 4.5 (P) SupabaseTimetableRepositoryを実装する
...
- [x] 4.8 (P) インフラストラクチャ層の依存性ルールを検証する
...
- [x] 5. メンバー一覧ページをClean Architectureに統合する
- [x] 5.1 Server Actionsを実装する
...
- [x] 5.3 パイロット機能の動作検証とリグレッションテストを実施する
...
- [x] 6. 残りの機能をClean Architectureに移行する
- [x] 6.1 イベント機能を移行する
...
- [x] 7.3 (P) アプリケーション層のユニットテストを実装する
...
- [x] 7.4 (P) インフラストラクチャ層の統合テストを実装する
